...
HD_PWD='E:/project/lab3_risc/lab3_risc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log risc32_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source risc32_wrapper.tcl -notrace
