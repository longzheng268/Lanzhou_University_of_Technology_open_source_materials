...
HD_PWD='E:/project/lab3_risc/lab3_risc.runs/risc32_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc32_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc32_clk_wiz_0_0.tcl
