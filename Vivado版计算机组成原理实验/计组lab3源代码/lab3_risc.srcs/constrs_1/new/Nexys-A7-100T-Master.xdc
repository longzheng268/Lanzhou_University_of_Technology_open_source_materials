...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { pc_clr }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
#set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { pc_clr }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
