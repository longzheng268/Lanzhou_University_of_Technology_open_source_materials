...
HD_PWD='E:/project/lab3_risc/lab3_risc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc32_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc32_wrapper.tcl
